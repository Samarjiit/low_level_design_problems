...
public class LoggerDemo {
    public static void main(String[] args) {
        LoggerFactory loggerFactory = new ErrorLoggerFactory();
        ILogger logger = loggerFactory.createLogger();

        logger.log("This is an error log message");

        LoggerFactory loggerFactoryy = new InfoLoggerFactory();
        ILogger loggerr = loggerFactoryy.createLogger();

        loggerr.log("this is info log message");
    }
}